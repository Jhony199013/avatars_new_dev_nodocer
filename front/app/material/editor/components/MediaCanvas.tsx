  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          width: `${Math.min(28, Math.max(20, Math.min(element.width, element.height) * 0.06))}px`,
          height: `${Math.min(28, Math.max(20, Math.min(element.width, element.height) * 0.06))}px`,
          transform: 'translate(50%, -50%)',
        }}

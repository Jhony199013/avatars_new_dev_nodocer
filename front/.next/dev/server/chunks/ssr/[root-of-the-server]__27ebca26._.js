...
"[project]/app/material/editor/servers/data:4dae4b [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$material$2f$editor$2f$servers$2f$data$3a$4dae4b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/material/editor/servers/data:4dae4b [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function EditorSidebar({ aspectRatio, onAspectRatioChange, videoTitle, onVideoTitleChange, avatars, isLoadingAvatars, voices, isLoadingVoices, scenes, activeSceneId, onSelectScene, onAddScene, onDeleteScene, onSceneVoiceChange, onSceneScriptChange, onSceneAvatarChange }) {
    ...
    const handlePlayClick = async (sceneId, sceneIndex)=>{
        ...
        let baseAudioUrl;
        try {
            const audioUrlResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$material$2f$editor$2f$servers$2f$data$3a$4dae4b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["GetAudioUrl"])({
                userUuid,
                slideNumber,
        ...
        if (!textChanged && existingAudio) {
            // Убираем query параметры для сравнения
            const existingSrcWithoutParams = existingAudio.src.split('?')[0];
            if (existingSrcWithoutParams === baseAudioUrl) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27ebca26._.js.map
...
_s(Header, "mDFrq5Ce5LtZN8NlcxDWeTx5Ro0=", false, function() {
    return [
...
function VoiceCreateModal({ isOpen, onClose, onVoiceCreated }) {
    ...
    const [audioLevel, setAudioLevel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // Уровень громкости (0-100)
    const [isTestingMicrophone, setIsTestingMicrophone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Тест микрофона до записи
    const [recordingTimer, setRecordingTimer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(120); // Таймер записи в секундах (2 минуты)
    ...
    const stopTimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[stopTimer]": ()=>{
    ...
    const stopAudioAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[stopAudioAnalysis]": ()=>{
    ...
    const startAudioAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[startAudioAnalysis]": (stream)=>{
            try {
                ...
                const updateAudioLevel = {
                    "VoiceCreateModal.useCallback[startAudioAnalysis].updateAudioLevel": ()=>{
    ...
    }["VoiceCreateModal.useCallback[startAudioAnalysis]"], []);
    ...
    const showError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[showError]": (message)=>{
            setErrorModal({
                isOpen: true,
                message
            });
        }
    }["VoiceCreateModal.useCallback[showError]"], []);
    ...
    const startMicrophoneTest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[startMicrophoneTest]": async ()=>{
            try {
    ...
    }["VoiceCreateModal.useCallback[startMicrophoneTest]"], [
        startAudioAnalysis,
        showError
    ]);
    const stopMicrophoneTest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[stopMicrophoneTest]": ()=>{
            setIsTestingMicrophone(false);
            stopAudioAnalysis();
            if (streamRef.current) {
                streamRef.current.getTracks().forEach({
                    "VoiceCreateModal.useCallback[stopMicrophoneTest]": (track)=>track.stop()
                }["VoiceCreateModal.useCallback[stopMicrophoneTest]"]);
                streamRef.current = null;
            }
        }
    ...
    const stopRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VoiceCreateModal.useCallback[stopRecording]": ()=>{
            if (mediaRecorderRef.current && mediaRecorderRef.current.state !== "inactive") {
                mediaRecorderRef.current.stop();
                setIsRecording(false);
                stopTimer();
                ...
                if (streamRef.current) {
                    streamRef.current.getTracks().forEach({
                        "VoiceCreateModal.useCallback[stopRecording]": (track)=>track.stop()
                    }["VoiceCreateModal.useCallback[stopRecording]"]);
                    streamRef.current = null;
                }
            }
    ...
    const handleCloneVoice = async ()=>{
        ...
        try {
            const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            if (user) {
                const { data: voicesData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("voices").select("id").eq("uid", user.id);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            (isTestingMicrophone || isRecording) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            errorModal.isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(VoiceCreateModal, "ZWI7gQMKmd05e7mH1nGkkoxy2IU=");
_c = VoiceCreateModal;
var _c;
...
//# sourceMappingURL=_abf246dc._.js.map
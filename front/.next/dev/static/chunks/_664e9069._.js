...
function AvatarUploadModal({ isOpen, onClose, onAvatarUploaded }) {
    ...
    const handleUpload = async ()=>{
        ...
        try {
            const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            if (user) {
                const { data: avatarsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("photo_avatars").select("id").eq("uid", user.id);
...
"[project]/app/avatars/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AvatarsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AvatarsPage.useEffect": ()=>{
            let isMounted = true;
            const fetchPhotoAvatars = {
                "AvatarsPage.useEffect.fetchPhotoAvatars": async ()=>{
                    ...
                    if (prefetchedData) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prefetchAvatars$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearPrefetchCache"])(); // Очищаем кеш после использования
            ...
            }["AvatarsPage.useEffect.fetchPhotoAvatars"];
            fetchPhotoAvatars();
            return ({
                "AvatarsPage.useEffect": ()=>{
                    isMounted = false;
    ...
    const refetchPhotoAvatars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AvatarsPage.useCallback[refetchPhotoAvatars]": async ()=>{
    ...
    }["AvatarsPage.useCallback[refetchPhotoAvatars]"], [
        currentUserId
    ]);
...
_s(AvatarsPage, "gWXY50DVOrhkqnazAIGknt0cohI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = AvatarsPage;
var _c;
__turbopack_context__.k.register(_c, "AvatarsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_664e9069._.js.map